                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('transferencias.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="id_conta_origem" name="id_conta_origem" class="form-control bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 py-3 text-lg w-full">
                        ...
                        <div class="form-group mt-4">
                            ...
                            <select id="id_conta_destino" name="id_conta_destino" class="form-control bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 py-3 text-lg w-full">
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input type="number" step="0.01" class="form-control bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 py-3 text-lg w-full" id="valor" name="valor" required>
                        </div>
